...
## SQLite Student Repository — SQL Contract
...
Governs: `sqlite_student_repository` (infrastructure layer)
...
* Accessing enrollment / junction tables
...
* Inserts only student-owned fields
...
## 3. SQL — `get(student_id)`

### Purpose

Retrieve a **single** `Student` by identity.
...
## 4. SQL — `remove(student_id)`

### Purpose

Delete a `Student` by identity.
...
Retrieve **all** students as independent entities.
